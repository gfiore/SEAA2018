...
\thanks{G.Fiore, and D. Di Ruscio are with the Department of Information Engineering, Computer Science and Mathematics, 
	University of L{'}Aquila, Italy, email: {\tt\footnotesize gabriella.fiore, davide.diruscio@univaq.it}.}%
...
%FLYAQ also allows users to specify no-fly zones, obstacles, etc., thus flight plans are generated according to these specifications, while also avoiding collisions among UAVs of the network. 
%
